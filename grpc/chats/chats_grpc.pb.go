...
type ChatServiceClient interface {
	ListChats(ctx context.Context, in *ListUserChatsRequest, opts ...grpc.CallOption) (*ListUserChatsResponse, error)
	Messages(ctx context.Context, in *ChatMessagesRequest, opts ...grpc.CallOption) (*ChatMessagesResponse, error)
...
func (c *chatServiceClient) ListChats(ctx context.Context, in *ListUserChatsRequest, opts ...grpc.CallOption) (*ListUserChatsResponse, error) {
	out := new(ListUserChatsResponse)
	err := c.cc.Invoke(ctx, "/chat_api.ChatService/ListChats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) Messages(ctx context.Context, in *ChatMessagesRequest, opts ...grpc.CallOption) (*ChatMessagesResponse, error) {
	out := new(ChatMessagesResponse)
	err := c.cc.Invoke(ctx, "/chat_api.ChatService/Messages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) CreateChat(ctx context.Context, in *CreateChatRequest, opts ...grpc.CallOption) (*CreateChatResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat_api.ChatService/CreateChat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) PostMessage(ctx context.Context, in *PostMessageRequest, opts ...grpc.CallOption) (*PostMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat_api.ChatService/PostMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) Get(ctx context.Context, in *GetChatRequest, opts ...grpc.CallOption) (*GetChatResponse, error) {
	out := new(GetChatResponse)
	err := c.cc.Invoke(ctx, "/chat_api.ChatService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	ListChats(context.Context, *ListUserChatsRequest) (*ListUserChatsResponse, error)
	Messages(context.Context, *ChatMessagesRequest) (*ChatMessagesResponse, error)
...
func (UnimplementedChatServiceServer) ListChats(context.Context, *ListUserChatsRequest) (*ListUserChatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListChats not implemented")
}
func (UnimplementedChatServiceServer) Messages(context.Context, *ChatMessagesRequest) (*ChatMessagesResponse, error) {
...
func (UnimplementedChatServiceServer) Get(context.Context, *GetChatRequest) (*GetChatResponse, error) {
...
func _ChatService_ListChats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_api.ChatService/ListChats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).ListChats(ctx, req.(*ListUserChatsRequest))
	}
...
func _ChatService_Messages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_api.ChatService/Messages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).Messages(ctx, req.(*ChatMessagesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChatService_CreateChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_api.ChatService/CreateChat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatService_PostMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_api.ChatService/PostMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_api.ChatService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chat_api.ChatService",
